...
{
	private void MapModelToUser(UserModel from, User to)
	{
		to.Username = from.Username;
	}

	private void MapSessionToModel(IMap map, Session from, SessionModel to)
	{
		to.Id = from.Id;
		if (from.User != null)
		{
	...
	private void MapUserToModel(User from, UserModel to)
	{
		to.Username = from.Username;
	}

	private void MapModelToSession(IMap map, SessionModel from, Session to)
	{
		to.Id = from.Id;
		if (from.User != null)
		{
